...
public class DriveConstants {
  ...
  public static final Rotation2d backLeftZeroRotation = new Rotation2d(1.423);
  public static final Rotation2d backRightZeroRotation = new Rotation2d(0.569);
  ...
  public static PathConstraints kTeleopPathConstraints =
      new PathConstraints(
          Units.feetToMeters(15 / 4),
          4.3 / 4,
          Units.degreesToRadians(540 / 4),
          Units.degreesToRadians(720 / 4));
